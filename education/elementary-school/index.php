  ...
  <div class="o-limit-x">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
      <div class="double-form__ls">
        ...
        <?php $APPLICATION->IncludeFile("/include/elementary_school/text1.php"); ?>

      </div>

      <?php $APPLICATION->IncludeFile("/local/include/sign_elementary_school.php"); ?>
...
<section class="advantages advantages__floating advantages-combo">
    <div class="o-limit-x">
        ...
        <h2 class="text-center">Цели начальной школы «МИР»</h2>

      <?php $APPLICATION->IncludeComponent("bitrix:news.list","achieve_together",Array(
          "DISPLAY_DATE" => "Y",
          "DISPLAY_NAME" => "Y",
          "DISPLAY_PICTURE" => "Y",
          "DISPLAY_PREVIEW_TEXT" => "Y",
...
<section class="accordion-list">
    <div class="o-limit-x">
        ...
        <h2 class="text-center">Начальная школа «МИР» это —</h2>
...
<section class="we we-slider">
    <div class="o-limit-x">
      ...
      <?php $APPLICATION->IncludeFile("/include/elementary_school/text2.php"); ?>
...
<section class="graduates school-graduates">
    <div class="o-limit-x">
      ...
      <?php $APPLICATION->IncludeComponent("bitrix:news.list","most_important_2",Array(
          "DISPLAY_DATE" => "Y",
          "DISPLAY_NAME" => "Y",
          "DISPLAY_PICTURE" => "Y",
          "DISPLAY_PREVIEW_TEXT" => "Y",
