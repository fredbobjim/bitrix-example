;(function() {
	...
	BX.Sale.BasketComponent = {
		...
		{
			var basketTotalCount = this.result.TOTAL_RENDER_DATA.COUNT_ITEMS
			var goodsDeclension = this.declination(basketTotalCount, ['товар', 'товара', 'товаров'])
			$('#total-basket-count').text(basketTotalCount)
			$('#total-basket-goods-declension').text(goodsDeclension)
