<div class="double-form__rs">
    <form id="entry-form" action="" class="double-form__form md:!p-11 !p-6">
        <input type="hidden" name="form_name" value="entry-middle-school">
        <h3 class="md:!mb-10 !mb-5">Записаться в начальную школу</h3>
        ...
        <button type="submit" class="btn-border btn-border__white">Отправить заявку</button>
